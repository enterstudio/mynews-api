...
var TestData = {
    ...
    Journalist: {
        ...
        last_name: 'Guy',
        slug: 'tester-guy',
        email: 'sfurnival+jdepp@gmail.com',
        status: '1',
    ...
    JournalistChanged: {
        ...
        last_name: 'Chopra',
        slug: 'munish-chopra',
        email: 'sfurnival+changed@gmail.com',
        status: '1',
        imageUrl : 'http://www.google.com',
    ...
    Journalist1: {
        first_name: 'Tester',
        last_name: 'Guy',
        email: 'sfurnival+test2@gmail.com',
        status: '1',
        url : 'http://www.itechfreak.com'
    },
    Journalist2: {
        first_name: 'Tester',
        last_name: 'Guy',
        email: 'sfurnival+test3@gmail.com',
        status: '1',
        url : 'http://www.itechfreak.com'
    },
    Article: {
    ...
    User: {
        first_name: 'Tester',
        last_name: 'Guy',
        email: 'sfurnival+mynews_testguy@gmail.com',
        password: 'test12345',
        status : 0
    },
    User1: {
...
describe('API - Journalists :', function() {
    ...
    test('> Integrity: POST /journalist with supplied :handle & @rid should be ignored, and remain unique', function(done) {
        ...
        TestData.Journalist.email = 'sfurnival+tg_changed@gmail.com';
